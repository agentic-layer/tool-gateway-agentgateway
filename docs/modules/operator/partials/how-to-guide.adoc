...
* **agentgateway**: Gateway implementation
* **Agent Runtime Operator**: Provides ToolGateway, ToolGatewayClass, and ToolServer CRDs

For detailed Agent Runtime Operator installation, see xref:agent-runtime-operator:agent-runtime:how-to-guide.adoc[Install the Agent Runtime Operator].
...
[source,bash]
----
kubectl apply -f https://github.com/agentic-layer/agent-runtime-operator/releases/download/v0.20.1/install.yaml
...
kubectl delete -f https://github.com/agentic-layer/agent-runtime-operator/releases/download/v0.20.1/install.yaml
